...
// message board routes ===============================================================
    ...
    app.post('/contacts', (req, res) => {
      db.collection('contacts').save({firstName:req.body.fName, lastName:req.body.lName, workEmail:req.body.wEmail, personalEmail:req.body.pEmail,  personalPhone:req.body.phoneNum, workPhone:req.body.phoneNumWork, address:req.body.address, contacts: req.body.contacts}, (err, result) => {
        if (err) return console.log(err)
